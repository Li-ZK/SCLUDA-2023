...
# from Config import BATCH_SIZE,lr,epochs,CLASS_NUM,HalfWidth,nBand,patch_size,momentum,l2_decay,param,alpha
...
def get_probs(data_loader, data_loader_t):
    ...
    test_features, test_labels = utils.extract_embeddings(feature_encoder, data_loader_t)  # (7826, 128) (7826,)
...
for iDataSet in range(nDataSet):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(1,num_iter):
            ...
            loss = cls_loss + 0.01 * lambd * lmmd_loss + contrastive_loss_t + contrastive_loss_s + 0.01 * domain_similar_loss
